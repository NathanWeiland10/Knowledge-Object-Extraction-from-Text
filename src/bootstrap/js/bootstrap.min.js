...
function readPDF(file) {
  ...
  const textContent = [];
  const keywordList = textArray;  // Assuming textArray contains your keywords
  ...
  reader.onload = function (event) {
    ...
    Promise.resolve().then(() => {
      ...
      sentences.forEach((sentence) => {
        const normalizedSentence = sentence.replace(/\s+/g, ' ').trim();  // Normalize spaces
      ...
      // Do something with the sentences containing keywords
